 ...
 *   setDashboardContext();
 *
 *   // In +page.svelte (or any child)
 *   import { getDashboardContext } from '$lib/stores/dashboard.svelte.js';
 *   const ctx = getDashboardContext();
 *   // ctx.activePanel, ctx.selectedId, ctx.handleSelect, etc.
 *
 * Issue #38: Data Integration — layout/route fix
 */
...
/**
 * Create and register the dashboard context. Call once in +layout.svelte.
 */
...
/**
 * Retrieve the dashboard context. Call in +page.svelte or any child component.
 */
